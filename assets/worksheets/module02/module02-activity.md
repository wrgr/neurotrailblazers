# Module 02 Activity Worksheet

**Module:** Module 02: Research Foundations and the Hidden Curriculum  
**Duration:** 4 hours  
*Generated from the module page. Edit `modules/module02.md`, not this file.*
...
1. What norms are assumed but rarely taught?
   - Your answer:
2. How do I ask for help effectively in research spaces?
   - Your answer:
...
- [ ] Decode one research setting's unwritten rules.
- [ ] Map roles and communication paths.
- [ ] Practice help-seeking script.
- [ ] Define personal support network.
- [ ] Identify ethical considerations relevant to your dataset.
- [ ] Draft attribution and collaboration norms for your team.
...
*Module page: `/modules/module02/` · Session kit: `/teaching/sessions/module02/` · [Facilitator guide](/teaching/facilitator-guide/)*
