# Module 04 Activity Worksheet

**Module:** Module 04: Neuroanatomy for Connectomics  
**Duration:** 4 hours  
*Generated from the module page. Edit `modules/module04.md`, not this file.*
...
1. What anatomical context is needed for robust interpretation?
   - Your answer:
2. Where do local cues fail without region-level information?
   - Your answer:
...
*Module page: `/modules/module04/` · Session kit: `/teaching/sessions/module04/` · [Facilitator guide](/teaching/facilitator-guide/)*
