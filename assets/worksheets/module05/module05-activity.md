# Module 05 Activity Worksheet

**Module:** Module 05: Electron Microscopy and Image Basics  
**Duration:** 4 hours  
*Generated from the module page. Edit `modules/module05.md`, not this file.*
...
1. Which artifacts critically affect reconstruction quality?
   - Your answer:
2. What minimum image quality supports downstream segmentation?
   - Your answer:
...
*Module page: `/modules/module05/` · Session kit: `/teaching/sessions/module05/` · [Facilitator guide](/teaching/facilitator-guide/)*
