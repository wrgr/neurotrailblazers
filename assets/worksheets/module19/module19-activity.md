# Module 19 Activity Worksheet

**Module:** Module 19: Peer Review and Scientific Ethics  
**Duration:** 4 hours  
*Generated from the module page. Edit `modules/module19.md`, not this file.*
...
1. What makes a review technically useful instead of opinion-based?
   - Your answer:
2. Where do integrity risks appear in large-scale connectomics projects?
   - Your answer:
3. How should authorship and credit be managed in consortium settings?
   - Your answer:
