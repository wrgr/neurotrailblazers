...
1. What minimum metadata is needed for third-party reuse?
   - Your answer:
2. How should dataset/code versioning be documented in publications?
   - Your answer:
3. Which reproducibility norms are implicit and must be taught explicitly?
   - Your answer:
...
*Module page: `/modules/module21/` · Session kit: `/teaching/sessions/module21/` · [Facilitator guide](/teaching/facilitator-guide/)*
