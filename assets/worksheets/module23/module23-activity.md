# Module 23 Activity Worksheet

**Module:** Module 23: Posters, Abstracts, and Conferences  
**Duration:** 4 hours  
*Generated from the module page. Edit `modules/module23.md`, not this file.*
...
1. What makes an abstract competitive and technically honest?
   - Your answer:
2. How should poster design reflect inferential structure?
   - Your answer:
3. Which conference norms should be taught explicitly?
   - Your answer:
...
*Module page: `/modules/module23/` · Session kit: `/teaching/sessions/module23/` · [Facilitator guide](/teaching/facilitator-guide/)*
