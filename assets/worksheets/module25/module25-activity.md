# Module 25 Activity Worksheet

**Module:** Module 25: Portfolio, Feedback, and Final Project  
**Duration:** 5-6 hours  
*Generated from the module page. Edit `modules/module25.md`, not this file.*
...
1. Which artifacts best demonstrate technical competency?
   - Your answer:
2. How should failure and revision be documented constructively?
   - Your answer:
3. What evidence of growth is credible to reviewers?
   - Your answer:
...
*Module page: `/modules/module25/` · Session kit: `/teaching/sessions/module25/` · [Facilitator guide](/teaching/facilitator-guide/)*
