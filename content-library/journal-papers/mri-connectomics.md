...
**Intermediate:** Benchmarking contemporary tractography approaches against tracer-derived ground truth, the authors find that advances in modeling and algorithms improved some measures without eliminating the false-positive burden, and that method choice remains a substantial source of variance in derived connectivity.
