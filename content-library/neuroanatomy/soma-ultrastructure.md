...
- **Purkinje cells** of the cerebellum are large (40-50 micrometers) and flask-shaped, with a single massive dendritic arbor extending into the molecular layer.
- **Granule cells** (cerebellar or dentate gyrus) are among the smallest neurons, only 6-10 micrometers in diameter, with scant cytoplasm surrounding a dark, heterochromatic nucleus.
...
- **Nuclear pore complexes**: These appear as interruptions in the double membrane, roughly 50-100 nm in diameter. At high magnification the octagonal symmetry of the pore complex can sometimes be resolved. Nuclear pores are the gateways for mRNA export and protein import, and they are abundant in metabolically active neurons.
...
- **Heterochromatin**: Appears as electron-dense clumps, typically found along the inner nuclear membrane and around the nucleolus. In neurons, heterochromatin is relatively sparse compared to oligodendrocytes or microglia, which often have dense, dark nuclei.
...
- **COPI and COPII coats**: At high magnification, coated vesicles may be visible near the Golgi stacks, mediating bidirectional transport between ER and Golgi.
...
- **Age-dependent accumulation**: Lipofuscin is rare in young tissue but increasingly prominent in adult and aged neurons. In the human H01 dataset (Shapson-Coe et al., 2024), lipofuscin granules are conspicuous in many neuronal somata and can be a dominant feature.
...
- **Size**: Often 1-10 micrometers in length, sometimes branched or forming networks visible across serial sections.
...
- **ER-mitochondria contacts**: Sites where the smooth ER membrane comes within 10-30 nm of the outer mitochondrial membrane are involved in calcium signaling and lipid transfer.
...
- **Appearance**: Barrel-shaped structures approximately 200 nm in diameter and 400 nm long, composed of nine microtubule triplets arranged in a cylindrical wall.
...
- **Annotation note**: Centrioles are rare in single EM sections due to their small size and the low probability of sectioning through them. Their presence confirms neuronal or glial identity but does not discriminate between the two.
...
- **Neurofilaments** (10 nm intermediate filaments): Abundant in large motor neurons where they contribute to the large soma size. Less prominent in small interneurons. Neurofilament accumulation (spheroids) can occur in disease states.
...
- **Late endosomes/multivesicular bodies**: Larger vesicles (250-500 nm) containing intraluminal vesicles, en route to lysosomes. See organelle-cues.md for detail.
