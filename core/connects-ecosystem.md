...
- **Mentoring.** The [models-in-practice playbook]({{ '/models/' | relative_url }}) gives mentors the MERIT stages, what the mentee produces in each, and the failure mode each stage exists to prevent.
