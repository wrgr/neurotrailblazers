...
description: "A NeuroTrailblazers graduate lecture. What is live now in connectomics ethics (license compliance, credit for proofreading labor) and what is prospective (consent at scale, de-identification, neural-data regulation, dual use), stated at its real strength."
---
...
<p class="roadmap">Part A — Human tissue: consent and de-identification<br>Part B — Licenses: what a reuser must do<br>Part C — Dual use and credit for proofreading</p>
...
documents it cites. It holds facts, not decisions: practicing the judgment -- how to
...
**License obligations** (Part B). Major portals redistribute under different terms, and a reuser who ignores them is simply in breach.

**Credit for proofreading labor** (Part C). Tens of thousands of hours of human correction sit behind a whole-brain connectome such as FlyWire, and how that work is credited decides real careers. **The one topic here about people affected today.**
...
- Consent framings written for a cubic millimeter of discarded tissue, not for whole-brain human volumes or machine-learning corpora
...
**3** — **Determine** what a dataset's license obliges a reuser to do, and whether a planned use is permitted.

**4** — **Distinguish** governed, arguable and actual dual-use concerns, at their real strength.

**5** — **Compare** credit models for proofreading labor, and state what each costs the contributor.

<div class="box">

Objective 3 is the material people skip and then get wrong. In at least one flagship case, the paper and the data carry different licenses.
...
**Part B — Licenses** *(live now)* Five resources, five license positions; the FlyWire row; funder and repository layers; a decision table.

</div>
<div>

**Part C — Dual use and credit** *(one prospective, one live)* Three dual-use concerns at their real strength; the scale of proofreading labor; four credit models in use; what to do about it.

<div class="box box--good">

**Bring to each part:** a connectomics dataset you have used or plan to use. By the end you should know where its ethics statement is, what its license lets you do, and how its proofreaders were credited.
...
| Dataset | 1.4 PB aligned (1.8 PB raw) |
| Content | About 57,000 cells (16,087 neurons); about 150 million synapses |

<p class="src">Shapson-Coe et al. 2024, <em>Science</em> 384, eadk4858 (10.1126/science.adk4858).</p>

<!--
Figures from the Science article: 5,019 sections, mean 33.9 nm; 4 × 4 nm pixels; "~1.4
petabytes" is the aligned dataset, and the Methods give 1.8 PB for the raw acquisition;
57,180 cells, of which 16,087 are neurons; 149,871,669 automatically detected synapses.
-->
...
A full-text search of the published *Science* article for "consent", "IRB", "ethics" and "Institutional Review" returns nothing. The data-availability statement points at the release landing page, and the license line covers the article, not the data.
...
- **Population size.** "A 45-year-old woman who had an anterior temporal resection for drug-resistant epilepsy, at a named center, in a narrow window of years" is a small set of people.
...
### Licenses: what a reuser is actually obliged to do

- Five resources, five license positions
...
| Resource | License | What you must do | Commercial use |
|---|---|---|---|
...
landing page itself carries no license line, which is why it is easy to miss.
-->
...
**A commercial product built on FlyWire connectivity is a license problem.**
...
<p class="ask">Your lab spins out a company that sells a connectome-constrained model trained on FlyWire. Which license governs, and what does it say?</p>

<!--
Answer: the data license, CC BY-NC 4.0. The paper being CC BY does not help; the
...
## Two more layers above the per-dataset license
...
That is one reason CONNECTS-scale projects release data at all — **but it grants a reuser nothing beyond what the dataset's own license grants.**
...
Jwa & Poldrack (2022) surveyed data-sharing policies across neuroimaging repositories. Access control and restrictions on secondary use **vary widely** — from fully open, download-and-reanalyze without constraint, to controlled access requiring verified credentials and limiting permitted secondary analyses.

<div class="box box--good">

**The practical lesson: "the data is public" is not a license statement.**
...
| You want to… | Check |
|---|---|
| Put a published figure in your paper or slides | The **article** license, not the data license |
| Redistribute a derived table (e.g. an edge list) | The **data** license plus its attribution requirements |
| Train a model on the imagery | The data license; a NonCommercial clause reaches the model if the model is commercial |
...
**MICrONS — yes.** It is CC BY 4.0, which permits commercial use provided you attribute, mark modifications, and link the license.

</div>
<div>

**FlyWire's data — no.** The data release is CC BY-NC 4.0, so a paid product is outside the license — **even though FlyWire's *Nature* paper is CC BY and its figures are reusable.**
...
- The scale of proofreading labor
...
**The mitigation is a writing habit.**

Write the sample description into the claim, **every time**.
...
## Credit for proofreading labor: the scale

<div class="cols">
<div>

Dorkenwald et al. (2024) estimate that FlyWire's brain reconstruction took **around 33 person-years of manual proofreading**, distributed across consortium labs, centralized teams at Princeton and Cambridge, and citizen scientists worldwide.
...
**The absence is itself a finding:** the largest single labor input to a connectome is routinely unquantified in the paper that reports the connectome.
...
| **Per-contribution platform attribution** | FlyWire Codex shows per-cell credits and a labeling leaderboard | A durable, checkable link to specific work | Not a publication; depends on the platform continuing to exist |
...
- **Legal advice and jurisdiction-specific law.** GDPR special-category data, US state genetic-privacy statutes and national neurorights legislation are real and consequential; none is analyzed here. **Nothing here substitutes for your institution's research-compliance office.**
...
**Practicing the judgment.** The site's peer-review and scientific-ethics module, with a review-board simulation — where these facts become decisions.

**Neighboring pages.** The H01 case study (its pathology caveats); the FlyWire case study (the community whose labor Part C counts); Provenance and versioning (pinning the release you used); Synapse detection (a worked example of bounded claims); Datasets (access routes and per-dataset terms).
...
The live obligations are unglamorous: **read the license that actually governs, find the ethics statement before you cite, write the sample into the claim, and settle credit before the work.**
