...
10:00-24:00 | Queue classification exercise
  Present 12 errors with brief descriptions (rows `E01` to `E12` of the error report in the [Module 07 kit](/assets/kits/module07/README.md)). Learners work in pairs to:
