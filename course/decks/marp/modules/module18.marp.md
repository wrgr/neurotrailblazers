...
<!--
Materials
  One noisy connectomics table (synapse table with low-confidence entries, duplicate IDs, and missing cell-type labels): `noisy_synapses.csv` and `cell_types.csv` in the [Module 18 kit](/assets/kits/module18/README.md), a synthetic stand-in of about 30,000 rows.
