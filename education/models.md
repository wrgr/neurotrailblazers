...
This page is the operational version. For the summary framing, see the
[Research Incubator Model]({{ '/models/' | relative_url }}).
...
- [Research Incubator Model]({{ '/models/' | relative_url }}) — the summary framing
