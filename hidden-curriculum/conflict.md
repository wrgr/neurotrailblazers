...
description: "Disagreeing with someone senior, challenging a result, authorship disputes, and misconduct — including the honest cost of formal recourse and when leaving is the correct answer."
permalink: /hidden-curriculum/conflict/
...
> **"Can I check my understanding — you're saying the reciprocity enrichment holds because the degree-preserving null already controls for the hubs?**
> **I ran it with a distance-preserving null as well and the effect drops to 1.1×. That might mean I've built the null wrong. Could you look at how I set it up?"**
...
1. **Assume you are wrong first, and do the work.** Re-read the methods for what is not stated. Try to reproduce it. Most apparent errors are misreadings, and finding that out privately costs nothing.
2. **Ask someone who knows the subfield.** "Am I misreading this?" Often the answer is that the convention you find bizarre is standard and has a reason.
3. **Contact the authors.** Neutrally, specifically, with your reproduction attempt attached. Most people respond well, and a surprising number already know.
4. **Public comment** — a preprint comment, a post, a conference question — only if it matters, the authors have not engaged, and you can state it without attributing motive.
5. **Formal correction or retraction request** — for results that will mislead the field, not for results you disagree with.
...
[Lab norms]({{ '/hidden-curriculum/lab-norms/' | relative_url }}) covers the conventions. This is about what to do when they break.
...
<details markdown="1">
<summary>Your PI presents your analysis in a talk and describes it as work from the lab, without naming you. Scientific, credit, or conduct?</summary>
...
<details markdown="1">
<summary>You cannot reproduce a well-known result from a paper's stated parameters. What is your first move?</summary>
...
Legal advice — for anything with legal weight, talk to someone qualified, and note that your institution's lawyers act for the institution. It also does not cover the specific procedures at your institution, which you should look up now rather than during an incident, nor the ordinary difficult-conversation skills in [lab norms]({{ '/hidden-curriculum/lab-norms/' | relative_url }}).

## Related

- [Lab norms]({{ '/hidden-curriculum/lab-norms/' | relative_url }}) — authorship conventions, escalation paths, and what a PI expects but will not say
- [Belonging]({{ '/hidden-curriculum/belonging/' | relative_url }}) — including how to tell a bad environment from a knowledge gap
- [Career mechanics]({{ '/hidden-curriculum/career-mechanics/' | relative_url }}) — why positions are contingent, which shapes the power in most of these disputes
- [Reading and judging work]({{ '/hidden-curriculum/reading-and-judging/' | relative_url }}) — how to establish whether a result is actually fragile before you challenge it
