...
3. **20:00-34:00** generate sample outputs live for the worked example's three output classes (a query, a patch description, a citation list) and score reliability against a known answer; record agreement counts rather than impressions.
