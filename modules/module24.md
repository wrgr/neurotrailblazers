...
- **Your entire network routes through your supervisor.** Fill the mentorship map, identify the empty roles, and close one per term by initiating contact yourself. Use a conference for this if you have one available; see [Module 23]({{ '/modules/module23/' | relative_url }}).
...
- **The portfolio those applications point at.** Curating artifacts, writing evidence captions, and documenting revision are [Module 25]({{ '/modules/module25/' | relative_url }}).
