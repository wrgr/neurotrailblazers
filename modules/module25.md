...
- Unspoken portfolio expectations:
  ...
  - clear file naming/versioning signals professionalism.
  - acknowledging mistakes with correction steps increases credibility.
- Support moves:
  - provide artifact-selection rubric before curation.
  - normalize inclusion of "failure-to-fix" examples.
  - use staged feedback cycles with explicit criteria.
