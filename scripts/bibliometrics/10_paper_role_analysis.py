#!/usr/bin/env python3
"""
Step 10: Analyze paper importance through multiple lenses.

Key insight: Methods papers have different importance signatures than biology papers.
- High in-degree (cited by): Foundational/landmark work
- High out-degree (cites): Reviews, methodologies
- Temporal analysis: Methods might cite early, get cited later

Creates paper profiles with:
  1. In-degree: How many papers cite this one (impact/importance)
  2. Out-degree: How many papers this cites (scope/synthesis)
  3. In/Out ratio: Characterizes paper role
  4. Betweenness: Paper as bridge between communities
  5. Weighted by k-core: Local density matters
"""
import json
...
def load_rankings():
    """Load paper rankings with metrics."""
...
def main():
    ...
    for pid, rank in rankings.items():
        ...
        # High ratio (>1): Cited more than it cites (foundational, reviewed)
        # Low ratio (<1): Cites more than cited (methodological, synthesizing)
        # Neutral (~1): Balanced role
