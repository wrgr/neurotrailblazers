...
> **How to use**: Read phases in order. Within each phase, follow the numbered order — citation prerequisites are resolved so each paper appears after the papers it builds on.

> **Scoring**: composite = 0.35×PageRank + 0.25×citations + 0.20×betweenness + 0.20×recent_PageRank

> **Coverage**: 500 papers across 5 phases
