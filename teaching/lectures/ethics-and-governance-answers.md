...
description: "A worked licence audit, human-tissue checks, a proofreading-credit rule and a model data-use statement."
---
...
The team and its release are **invented**; the licence facts are real as checked for
this site. None of this is legal advice. Accept other reasoning that states its limits.

## 1. Licence and terms audit

| Dataset | Data licence and where stated | Part A | Part B startup | Release must include |
|---|---|---|---|---|
| MICrONS | CC BY 4.0, microns-explorer.org terms | Yes | Not used | Attribution, modifications marked, licence link, no added restrictions; cite MICrONS Consortium et al. (2025) |
...
A figure from the FlyWire *Nature* paper falls under the article licence, CC BY 4.0.
The connectome falls under the data licence. Part B cannot go to the startup while it
contains FlyWire connectivity, whatever the hemibrain answer turns out to be.

For hemibrain, a strong answer does not pick a licence. It records both sources and
...
- **Model training:** open. Whether consent to research use extends to training and
  releasing a model is not settled, and a CC BY licence does not answer it. Ask the
...
proofreading onto one CRediT role, such as *Data curation* or *Validation* (as H01
did), and write that mapping down. Measure effort from edit histories. Tell everyone
...
Score **0–2 each** for licence accuracy, handling of uncertainty, human-tissue scope
...
at least 6/8 and no zero in licence accuracy or handling of uncertainty. This is a
