---
layout: page
title: "Ethics and Governance: lecture package"
...
seminar or a 50–60 minute talk without the activity. This plan selects slides
rather than asking an instructor to cover all 31.

- [Open presentation]({{ '/course/decks/marp/out/lectures/ethics-and-governance.html' | relative_url }})
...
and review the worksheet/key. **Prerequisites:** none beyond a general idea of what a
connectome dataset is. The Introduction session's claim framework helps with the
over-claiming discussion but is not required. Provide paper or a text editor.
**No accounts, dataset downloads, legal training or coding are required.**
...
- **70–80 min, slide 28:** pairs draft section 4 and exchange notes. Show slide 28's
  ...
  determination.
- **80–90 min, slides 27 and 29:** debrief with the key and slide 27's credit
  question, allow three minutes for the worksheet's carry-forward, then collect the
  exit ticket. Ask for one obligation the team must meet and one question it cannot
  settle itself.

Slides 4–6, 8, 11, 15, 18 and 21–22 are optional extension material; 30–31 hold
references and credit. Slide numbers include the cover. Add slide 11 (oversight
regimes) and 22 (dual use at its real strength) if running a longer seminar.
...
question for machine-learning reuse open; the deck states that no settled answer
exists. The UNESCO Recommendation, adopted 11 November 2025, is non-binding, and
whether it covers volume EM data is not settled.
...
[Janelia hemibrain page](https://www.janelia.org/project-team/flyem/hemibrain).
