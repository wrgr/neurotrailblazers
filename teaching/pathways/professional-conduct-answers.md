---
layout: page
title: "Professional Conduct in STEM: instructor model responses"
permalink: /teaching/pathways/professional-conduct-answers/
slug: pathways-professional-conduct-answers
track: career-and-community
content_type: delivery
description: "Worked rulings on five invented scenarios, a model error report and a feedback rubric."
---

[Learner worksheet]({{ '/teaching/pathways/professional-conduct-activity/' | relative_url }}) · [Workshop plan]({{ '/teaching/pathways/professional-conduct/' | relative_url }})

These responses use the worksheet's **invented** lab. They are examples, not the only
acceptable rulings. This page is public and suitable for formative feedback. It is not
legal advice and not a ruling on any real case.
...
The pattern to point out: the rung is set by the kind of problem, but the first sentence
is almost always a question to the nearest person.
...
**Strong:** a name or office on every rung, including one rung-2 person outside the lab,
and honest **?** marks on rung 3. **Weak:** the same person on every rung, or rung 3
left blank because "it won't come up".

## Feedback rubric

Score four dimensions **0–2 each**:

1. **Classification.** 2 = all five classified with a reason, FFP kept separate from
   error and disagreement; 1 = three or four; 0 = misconduct used for any wrong.
2. **Proportionate rung.** 2 = lowest adequate rung each time, with a question to the
   nearest person first; 1 = one over- or under-escalation; 0 = two or more.
3. **Obligations are actions.** 2 = each starts "I must" or "I must not" and names an
   act; 1 = most; 0 = feelings or general principles.
4. **Error report.** 2 = four parts, before the fix, no apology up front; 1 = one part
   missing; 0 = waits for the fix or leads with apology.
...
Do not grade the rung map, and do not grade whether a learner says they would personally
