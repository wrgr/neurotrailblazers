...
## Deck intent
This is a draft lecture deck outline for **Glia** in the Technical Training track.
...
4. Core concept A: Glia classes and cues
5. Core concept B: Glia-neuron boundary decisions
6. Core concept C: Proofreading implications
